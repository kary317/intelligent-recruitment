...
async def resume_ocr_test():
    file_path = os.path.join(settings.RESUME_DIR, "bce00f65-6fae-4fae-8011-5b4353c140f7.pdf")
...
async def agent_test(
    ...
    async with session.begin():
        ...
        candidate_model = await candidate_repo.get_by_id("cYhZupqktyapJJiqxDZsjK")
        position_model = await position_repo.get_by_id("3QqT63h6WCWasA5JcY3TtT")
        interviewer_model = await user_repo.get_by_id("PQdQh45tAehJp4YH9mLaTt")
